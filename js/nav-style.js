...
for (const i of navLinkImages) {
  ...
  <div class="p-2 lg:p-4 bg-slate-900 bg-opacity-5 rounded-full border border-gray-950 border-opacity-15 justify-start items-center inline-flex cursor-pointer tooltip" data-tip="${i}">
